...
import { MainDiv2, InnerDiv2, FirstInnerDiv2, Picture, H2Ele, ElemPic, H5Elem, ButtonFE } from "./Goal-css";
    ...
    <MainDiv2>
      <InnerDiv2>
        <FirstInnerDiv2>
          ...
          <ButtonFE onClick={() => history.push("/courses")}>Watch now</ButtonFE>
        </FirstInnerDiv2>
        <FirstInnerDiv2>
          ...
          <ButtonFE onClick={() => window.location.href="https://play.google.com/store/apps/details?id=com.unacademyapp&referrer=utm_source%3DFooter%26utm_medium%3DWebApp%26utm_campaign%3DFooter%26"}>
            Get the app
          </ButtonFE>
        </FirstInnerDiv2>
      </InnerDiv2>
